...
then
    ...
    echo -e "$Y Nothing to do .. MYSQL already installed $N" | tee -a $LOG_FILE
fi
...
then
    ...
    echo -e "$Y Nothing to do.. python3 already installed.$N" | tee -a $LOG_FILE
fi
...
then
    ...
    echo -e "$Y Nothing to do.. nginx already installed $N" | tee -a $LOG_FILE
fi